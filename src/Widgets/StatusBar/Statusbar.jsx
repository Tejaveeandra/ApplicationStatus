...
const Statusbar = ({ isSold, isConfirmed }) => {
  const blue = "#3425FF";
  const red = "#FF2525";
  ...
  // Case: Neither sold nor confirmed -> only red cross
  if (!finalSold && !isConfirmed) {
    return (
    ...
    <div className="status-container">
      ...
      <div className="status-labels">
        <div className="label-container">
          <span className={`label-sale ${isSold ? "sold" : ""} ${isConfirmed ? "confirmed" : ""}`}>
            Sale
          </span>
        </div>
        <div className="label-container">
          <span className={`label-confirm ${isConfirmed ? "confirmed" : ""}`}>
            Confirm
          </span>
        </div>
      </div>
